...
- **Perfil do jogador** 🧑‍🎨 — a criança escreve o nome e escolhe um avatar **ilustrado, redondo e grande** (25 opções: crianças, princesas, dinossauros, bichinhos e robôs), com **seletor de tom de pele** (6 tons, estilo emoji do WhatsApp) para os avatares de pessoas
